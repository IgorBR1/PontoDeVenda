...
<body>
	...
	<?php if($cabecalho_img_rel == 'Sim'){ ?>
		...
		<div class="img-cabecalho my-4">
			<img src="<?php echo $url_sistema ?>img/logo.png" width="100%">
		</div>
		...
		<div class="cabecalho">
			...
			<div class="row titulos">
				<div class="col-sm-2 esquerda_float image">	
					<img src="<?php echo $url_sistema ?>img/logo.png" width="90px">
				</div>
	...
	<table class='table' width='100%'  cellspacing='0' cellpadding='3'>
		...
		for ($i=0; $i < @count($res); $i++) { 
			...
			<tr>
				...
				<td><img src="<?php echo $url_sistema ?>img/produtos/<?php echo $foto ?>" width="35px"> </td>
